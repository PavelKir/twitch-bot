...
def pass_to_function(command, args, username):
    command = command.replace('!', '')

    # сюда можно прикрутить более крутой обработчик комманд
    #print username - пользователь, использовавший команду
    #print command - название команды
    #print args - аргументы команды
